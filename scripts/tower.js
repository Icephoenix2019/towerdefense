class Tower {
    ...
    if (imagelib.hasOwnProperty(this.imageBarrel)) {
            image(imagelib[this.imageBarrel], 0, this.width * ts / 2 + 25, this.length * ts, this.width * ts );
        } else {
        stroke(this.border);
        fill(this.secondary);
    ...
    drawBase() {
        if (imagelib.hasOwnProperty(this.imageBase)) {
            image(imagelib[this.imageBase], this.pos.x - ts / 2, this.pos.y - ts / 2, this.radius * ts, this.radius * ts);
        } else {
            stroke(this.border);
            fill(this.color);
